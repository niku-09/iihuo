'==============================================================
' fix_sliver_strip.bas
'--------------------------------------------------------------
' Applies a precomputed action list to the model.
'
' The action list (FIX_SLIVER_STRIP.csv) comes from a full
...
Const CSV_PATH    As String = "C:\Users\nikhil.mohan\Desktop\Analysis testing\audit\FIX_SLIVER_STRIP.csv"
...
Sub Main
    ...
    Close #logF
    femap.feAppMessage 0, "fix_sliver_strip done. See " & OUT_DIR & "fix_all.log"
