...
'
' The action list (FIX_ACTIONS_ROUND5.csv) comes from a full
...
Const CSV_PATH    As String = "C:\Users\nikhil.mohan\Desktop\Analysis testing\audit\FIX_ACTIONS_ROUND5.csv"
...
Sub Main
    ...
    Close #logF
    femap.feAppMessage 0, "fix_all_r5 done. See " & OUT_DIR & "fix_all.log"
